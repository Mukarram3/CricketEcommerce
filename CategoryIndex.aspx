<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="CategoryIndex.aspx.cs" Inherits="CricketEcommerce.CategoryIndex" %>
                ...
                <asp:Repeater runat="server" ID="rpt">
                    ...
                    <div class="col-md-3">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <asp:HyperLink ID="HyperLink1" style="" runat="server" CssClass="imageproduct" NavigateUrl='<%# Eval("ID","~/ProductIndex.aspx?CID={0}") %>'>
                                    <img src="assets/images/<%# Eval("Image") %>" style="width: 200px; height: 250px;">
                                     </asp:HyperLink>
                            </div>
                            <div class="panel-heading">
                                <p><%# Eval("Description") %></p>
                                <asp:HyperLink ID="pdetail" style="" runat="server" Text="Confirm" CssClass="btn btn-primary btn-xs" NavigateUrl='<%# Eval("ID","~/ProductIndex.aspx?CID={0}") %>'>Quick Look</asp:HyperLink>
