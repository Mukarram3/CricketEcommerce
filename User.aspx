            ...
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <asp:Label runat="server" AssociatedControlID="txtemail" class="label" Text="Email Address"></asp:Label>
                            ...
                            <div class="col-lg-6">
                                <asp:Label runat="server" AssociatedControlID="txtpass" class="label" Text="Password"></asp:Label>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <asp:Label runat="server" AssociatedControlID="txtrepass" class="label" Text="Repeat Password"></asp:Label>
                            ...
                            <div class="col-lg-6">
                                <asp:Label runat="server" AssociatedControlID="txtphone" for="phone" class="label" Text="Phone"></asp:Label>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <asp:Label runat="server" AssociatedControlID="txtrepass" class="label" Text="Choose Image"></asp:Label>
                                <asp:FileUpload runat="server" ID="file" CssClass="form-control" />
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="image" ErrorMessage="Please Choose Image" ForeColor="Red"></asp:RequiredFieldValidator>

                            </div>
                            <div class="col-lg-6">
                                <asp:Label runat="server" AssociatedControlID="txtphone" for="phone" class="label" Text="Type"></asp:Label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <asp:Label runat="server" AssociatedControlID="txtstatus" for="phone" class="label" Text="Status"></asp:Label>
